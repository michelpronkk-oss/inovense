  ...
  const agents = [
    {
      ...
      glyph: (<><path d="m3 17 6-6 4 4 8-9"/><path d="M14 6h7v7"/></>),
      tag: "Sales · Pipeline",
      bullets: [
    ...
    },
    {
      ...
      glyph: (<><path d="M3 11v2l11 5V6L3 11Z"/><path d="M18 8a3.5 3.5 0 0 1 0 8"/></>),
    ...
    },
    {
      ...
      glyph: (<><circle cx="9" cy="8" r="3.1"/><path d="M3.6 20c0-3.3 2.4-5.4 5.4-5.4 1.1 0 2.1.3 3 .9"/><path d="m15.5 18 1.7 1.7 3.3-3.4"/></>),
    ...
    },
    {
      ...
      glyph: (<><path d="M4 20V11M10 20V5M16 20v-7M22 20H2"/></>),
    ...
    <section className="section" id="agents">
      <div className="container">
        <div className="section-head">
          ...
          <p className="lede">
            Inovense operators are scoped to a role and trained on the way your business runs.
            They plan multi-step work, act where you've allowed it, and hand the rest to a human.
            These four lead the launch — fifteen in all.
          </p>
        </div>
        ...
        <div className="ag-more">
          <a href="Operators.html" className="btn btn-ghost btn-lg ag-more-btn">
            Explore all 15 operators <I.arrow size={14} />
          </a>
        </div>
      </div>
      ...
      <style>{`
        ...
        .ag-card-person { width: 24px; height: 24px; }
        .ag-card-badge {
          position: absolute; right: -3px; bottom: -3px;
          width: 19px; height: 19px; border-radius: 50%;
          display: grid; place-items: center;
        }
        .ag-card-badge svg { width: 11px; height: 11px; }
  ...
  <div className="ag-card" style={{ "--accent": a.color }}>
    <div className="ag-card-head">
      <div className="ag-card-avatar"
        style={{ background: `linear-gradient(135deg, ${a.color}26, ${a.color}08)`, boxShadow: `inset 0 0 0 1px ${a.color}55` }}>
        <svg className="ag-card-person" viewBox="0 0 24 24" fill={a.color}><circle cx="12" cy="8.5" r="3.6"/><path d="M5 20c0-3.9 3.1-6.5 7-6.5s7 2.6 7 6.5z"/></svg>
        <span className="ag-card-badge" style={{ color: a.color, background: "#0A0E12", boxShadow: `0 0 0 2px var(--bg), inset 0 0 0 1px ${a.color}77` }}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round">{a.glyph}</svg>
        </span>
      </div>
      <div style={{ minWidth: 0 }}>
    ...
    <div className="ap-card">
      <div className="ap-card-head">
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <strong style={{ fontSize: 13, fontWeight: 500 }}>Approval · preview</strong>
