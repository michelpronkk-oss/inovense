...
assert.doesNotMatch(page, /Connected · Healthy/);
assert.match(page, /Available to Auterim/);
assert.match(page, /Document scope/);
assert.match(page, /Read-only access/);
assert.doesNotMatch(page, /Access & control/);
