...
export default function V3Page() {
  ...
  return <div className="auterim-v3-page">
    ...
    <section className="sec" id="pricing">
      <div className="wrap">
        <Head label="Getting started" title="Choose the plan that fits your operation." body="Start with a three-day trial, then connect systems and deploy approval-gated operators when you are ready." />
