export default function SystemsStandard() {
  return (
    <section className="relative overflow-hidden border-y border-white/[0.06] py-28 md:py-40">
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        ...
        <p className="text-3xl font-semibold leading-tight tracking-tight text-zinc-50 md:text-4xl lg:text-5xl">
          &ldquo;No duct tape. No AI experiments.
          <br />
          <span className="text-brand">
            Just systems that work.&rdquo;
          </span>
        </p>

        {/* Supporting copy */}
        <p className="mx-auto mt-10 max-w-xl text-base leading-relaxed text-zinc-400 md:text-lg">
          We don&apos;t bolt automations onto broken processes. We don&apos;t
          sell vague AI capability. We design operational infrastructure that
          fits your business, runs reliably, and makes your team faster without
