    ...
    <section className="relative overflow-hidden pb-24 pt-32 md:pb-32 md:pt-44">
      ...
      <div className="relative mx-auto max-w-5xl px-6">
        <div className="mb-8 flex flex-wrap items-center gap-2">
          ...
          <span className="inline-flex items-center rounded-full border border-zinc-700/60 px-3 py-1 text-[11px] font-medium text-zinc-500">
            Operator-grade uitvoering
          </span>
        </div>

        <h1 className="max-w-3xl text-4xl font-semibold leading-tight tracking-tight text-zinc-50 md:text-6xl md:leading-[1.06]">
          Groei als systeem.{" "}
          <span className="text-brand">Niet als losse tactieken.</span>
        </h1>

        <p className="mt-6 max-w-2xl text-base leading-relaxed text-zinc-400 md:text-lg">
          We bouwen een complete groeilaag van capture en kwalificatie tot
          routing, contentdistributie en follow-up. Minder commercieel lek,
          meer voorspelbare pipeline.
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2">
          {["Geen growth theater", "Focus op commerciele output", "Reactie binnen 24 uur"].map(
            (item) => (
