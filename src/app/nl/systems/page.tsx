    ...
    <section className="relative overflow-hidden pb-24 pt-32 md:pb-32 md:pt-44">
      ...
      <div className="relative mx-auto max-w-5xl px-6">
        ...
        <h1 className="max-w-3xl text-4xl font-semibold leading-tight tracking-tight text-zinc-50 md:text-6xl md:leading-[1.06]">
          Systemen gebouwd op de manier{" "}
          <span className="text-brand">waarop jouw bedrijf echt werkt.</span>
        </h1>

        <p className="mt-6 max-w-2xl text-base leading-relaxed text-zinc-400 md:text-lg">
          AI-automatisering, workflow systemen, interne tools en operationele
          infrastructuur. Niet wat generieke software oplevert als je het
          aanpast. Gebouwd op basis van hoe jouw operatie daadwerkelijk draait.
        </p>
        ...
        <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-2">
          {["Op maat gebouwd", "Documentatie inbegrepen", "Reactie binnen 24 uur"].map(
            (item) => (
