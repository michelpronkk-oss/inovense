...
export default function InsightsPage() {
  ...
  useWorkspaceRealtimeInvalidation(state.workspace.id, ["insights", "workflows", "activity"], () => { void load(true); });
  ...
  const lastUpdatedAt = outcomes[0]?.observedAt ?? null;
  ...
  return <div className="os-page insights-page">
    <PageHeader eyebrow="Measured outcomes" title="Insights" description="Evidence Auterim has observed after work completed. Activity and technical logs remain separate views." meta={<FreshnessIndicator updatedAt={lastUpdatedAt} realtimeStatus={realtimeStatus} />} actions={<Link className="btn btn-ghost btn-sm" href="/app/workflows">Open workflows</Link>} />
