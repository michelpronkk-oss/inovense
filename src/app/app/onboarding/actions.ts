...
export type OnboardingDraft = { fullName: string; workspaceName: string; websiteUrl: string; industry: string; teamSize: string; priority: "revenue" | "client_flow" | "operations" | "support" | ""; systems: string[]; noSupportedConnector: boolean; trialDeclined: boolean; step: number };
