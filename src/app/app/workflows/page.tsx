...
function EmptyWorkflows() { return <div className="p workflows-page-empty"><EmptyState title="No coordinated work yet">When a connected system produces a meaningful signal, Auterim can assemble a safe plan, prepare any required approvals, and record outcome evidence here.<div style={{ display: "flex", gap: 8, marginTop: 16 }}><Link href="/app/connectors" className="btn btn-primary btn-sm" style={{ textDecoration: "none" }}>Connect a system</Link><Link href="/app/agents" className="btn btn-ghost btn-sm" style={{ textDecoration: "none" }}>View operators</Link></div></EmptyState></div>; }
