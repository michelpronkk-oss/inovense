...
export default function WorkflowsPage() {
  ...
  return <div className="os-page">
    <div className="os-page-head"><div><span className="os-greet">Coordinated work</span><h1>Workflows</h1><div className="os-page-sub">The plans Auterim is handling across your connected systems. You stay in control of every consequential action.</div></div><div className="os-page-actions"><Link href="/app/approvals" className="btn btn-primary btn-sm" style={{ textDecoration: "none" }}>Review approvals</Link></div></div>
...
function EmptyWorkflows() { return <div className="p" style={{ padding: "28px 22px", maxWidth: 760 }}><div style={{ fontSize: 16, fontWeight: 650 }}>No coordinated work yet</div><div style={{ marginTop: 7, fontSize: 13, lineHeight: 1.55, color: "var(--text-dim)" }}>When a connected system produces a meaningful signal, Auterim can assemble a safe plan, prepare any required approvals, and record outcome evidence here.</div><div style={{ display: "flex", gap: 8, marginTop: 16 }}><Link href="/app/connectors" className="btn btn-primary btn-sm" style={{ textDecoration: "none" }}>Connect a system</Link><Link href="/app/agents" className="btn btn-ghost btn-sm" style={{ textDecoration: "none" }}>View operators</Link></div></div>; }
