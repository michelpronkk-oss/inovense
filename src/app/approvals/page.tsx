...
import { PageHero, MktCard, SectionDivider, PageCTA, StepRow } from "@/components/marketing-ui";
...
export const metadata: Metadata = {
  // Bare: the root layout applies the "%s | Auterim" title template.
  title: "AI Approval Workflows & Human Control",
  description,
...
const related = [["See how operators work", "/operators"], ["Explore controlled workflows", "/workflows"], ["Use cases", "/use-cases"], ["Security", "/security"], ["Trust center", "/trust"]] as const;
