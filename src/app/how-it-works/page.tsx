...
export default function HowItWorksPage() {
  return <PublicSiteFrame>
    ...
    <section className="public-feature how-it-works-flow"><div className="wrap rv"><OperatingFlow /></div></section>
    <StorySection className="how-it-works-loop" label="The operating loop" title="The work keeps its context. Your team keeps control.">
      <div className="public-principles rv">
    ...
    <div className="rv"><PublicCta title="Start with the work your team keeps chasing." description="Tell us what should move first. Early Access requests are reviewed before workspace invitations are sent." /></div>
    <RevealMount />
  </PublicSiteFrame>;
}
