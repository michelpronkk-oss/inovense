...
export default function LoginForm({ from }: { from: string }) {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (signInError) {
      setError("Sign-in failed. Use an authorized Auterim account.");
      setBusy(false);
      return;
    }
    router.replace(from);
