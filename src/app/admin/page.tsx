...
export default async function AdminOverviewPage({ searchParams }: { searchParams: Promise<{ range?: string }> }) {
  ...
  return <div className="admin-command-center">
    ...
    <div className="admin-kpi-grid"><Kpi label="MRR" value={data.kpis.mrr.value} note={data.kpis.mrr.label} kind="currency" /><Kpi label="Active subscriptions" value={data.kpis.activeSubscriptions.value} note={data.kpis.activeSubscriptions.label} /><Kpi label="Active workspaces" value={data.kpis.activeWorkspaces.value} note={data.kpis.activeWorkspaces.label} /><Kpi label="New workspaces" value={data.kpis.newCustomers.value} note={data.kpis.newCustomers.label} /><Kpi label="Visitor conversion" value={data.kpis.previewConversion.value} note={data.kpis.previewConversion.label} kind="percent" /><Kpi label="Runs" value={data.kpis.runs.value} note={data.kpis.runs.label} /></div>
