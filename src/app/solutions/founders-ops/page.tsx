      ...
      <main>
        <PageShell>
          ...
          <section className="mx-auto flex w-full max-w-4xl flex-col items-center px-6 pb-28 pt-40 text-center">
            ...
            >
              Move faster than a team twice your size.
            </h1>
            <p
              className="mb-10 max-w-[52ch] text-lg leading-relaxed"
              style={{ color: "#A4ABB4" }}
            >
              For founders running lean. Deploy operators that handle the work you would otherwise delegate or do yourself. Institutional knowledge stays in memory. Coordination happens automatically.
            </p>
          ...
          <PageCTA
            heading="Start running your business on Inovense."
