      ...
      <main>
        <PageShell>
          ...
          <section className="mx-auto flex w-full max-w-4xl flex-col items-center px-6 pb-28 pt-40 text-center">
            ...
            >
              The operational layer that runs under your business.
            </h1>
            <p
              className="mb-10 max-w-[52ch] text-lg leading-relaxed"
              style={{ color: "#A4ABB4" }}
            >
              Recurring tasks, cross-team coordination, and process execution handled by operators. Your team focuses on decisions that move the business forward.
            </p>
