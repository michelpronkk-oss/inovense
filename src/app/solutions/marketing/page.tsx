      ...
      <main>
        <PageShell>
          ...
          <section className="mx-auto flex w-full max-w-4xl flex-col items-center px-6 pb-28 pt-40 text-center">
            ...
            >
              Marketing that executes without a coordinator.
            </h1>
            <p
              className="mb-10 max-w-[52ch] text-lg leading-relaxed"
              style={{ color: "#A4ABB4" }}
            >
              Operators that run content workflows, track campaign performance, and surface optimization opportunities. Marketing at the pace of the business, not the calendar.
            </p>
