...
export type ConnectorKey = "gmail" | "hubspot" | "google_drive" | "notion" | "slack" | "stripe" | "linear" | "calendar";
...
export const OPERATOR_REGISTRY: OperatorDefinition[] = [
  {
    ...
    capabilities: ["Lead triage", "Follow-up drafting", "CRM handoff preparation", "Approval-gated email send"],
