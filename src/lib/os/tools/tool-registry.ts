...
export const TOOL_REGISTRY: ToolDefinition[] = [
  ...
  },
  {
    ...
    handler: () => simpleOutput("action_not_implemented", { action: "hubspot.create_or_update_contact" }),
  },
  {
    ...
    handler: () => simpleOutput("action_not_implemented", { action: "hubspot.update_deal" }),
  },
  {
