...
export const SEED_TEAM_MEMBERS = [
  ...
  { id: "tm-002", name: "Revenue Reviewer", email: "reviewer@auterim.com", role: "Reviewer", initials: "RR", color: "#A78BFA", access: ["Approvals", "Outputs"], status: "online" as const, active: true },
  { id: "tm-003", name: "Workflow Viewer", email: "viewer@auterim.com", role: "Viewer", initials: "WV", color: "#5B8DEF", access: ["View only"], status: "offline" as const, active: true },
];
