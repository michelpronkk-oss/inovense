...
import { GMAIL_SCAN_REQUIRED_SCOPES, getMissingGmailScopes, type StoredConnectorCredential } from "@/lib/connectors/gmail";
...
import { buildSalesforceTruth } from "@/lib/connectors/salesforce-truth";
...
export type { ConnectorTruthStatus, SafeConnectorTruth } from "@/lib/connectors/truth";
 ...
 *
 * The rule is explicit: a healthy Microsoft 365 mail connection must never be reported as a healthy Teams connection.
 *
...
export async function getConnectorTruth(input: {
  ...
  // â”€â”€ Google Drive: a capability of the shared Google credential â”€â”€â”€â”€â”€â”€â”€â”€
  //
  ...
  // â”€â”€ Slack (direct OAuth) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  //
  ...
  // â”€â”€ Trello (direct OAuth 1.0a) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  const rows: SafeConnectorTruth[] = [
    ...
    teamsTruth,
    buildSalesforceTruth({
      hasError: Boolean(salesforceRes.error),
      hasCredential: Boolean(salesforceRow),
      credentialStatus: salesforceRow?.status ?? null,
      ...
      configured: getSalesforceConfigStatus().configured,
    }),
    {
      connectorKey: "asana",
      displayName: "Asana",
