...
export const CONNECTOR_CATALOG: Record<string, ConnectorDefinition> = {
  ...
  intercom: {
    ...
    usedByOperators: ["client_flow", "operations", "support"], readActions: ["Read conversations", "Read contacts, companies, and admins"], writeActions: ["Reply after approval", "Assign after approval", "Update conversation after approval"],
  ...
  zendesk: {
    ...
    usedByOperators: ["client_flow", "operations", "support"], readActions: ["Read tickets", "Read ticket context", "Read customer context"], writeActions: ["Reply after approval", "Add internal note after approval", "Update ticket after approval"],
